...
const en_US = {
  ...
  "token.text1-2": <React.Fragment>Duel general certificate is the embodiment of the rights and interests of TRON Duel platform. Owning Duel can obtain <span className="text-hover">100%</span> of the profits of TRON Duel (including direct sharing, exchange repurchase, etc.), and can vote on important matters of the platform.</React.Fragment>,
  "token.text2-1": "Token distribution",
  "token.text2-2": <React.Fragment>Duel total amoun is <span className="text-hover">10,000,000,000（10B）</span>，Will be used for the following purposes:</React.Fragment>,
  "token.text2-3": <React.Fragment>① Betting Mining:<span className="text-hover">50%</span></React.Fragment>,
  "token.text2-4": <React.Fragment>② Private placement(Initial development server costs):<span className="text-hover">5%</span></React.Fragment>,
  "token.text2-5": <React.Fragment>③ Airdrop and promotion:<span className="text-hover">20%</span></React.Fragment>,
  "token.text2-6": <React.Fragment>④ Operating costs:<span className="text-hover">15%</span></React.Fragment>,
  "token.text2-7": <React.Fragment>⑤ Teams and consultants:<span className="text-hover">10%</span></React.Fragment>,
  ...
  "mining.text5": <React.Fragment>The total amount of Duel issued is <span className="text-hover">10,000,000,000 (10B)</span> and will be used for:</React.Fragment>,
  ...
  "mining.text8": <React.Fragment>For every <span className="text-hover">10%</span> dug out, the reward is reduced as follows:</React.Fragment>,
  "mining.phase": "Rount",
